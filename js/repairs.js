    ...
    <div class="form-row">
      <div class="form-group"><label class="form-label">Who's fixing it?</label>
        ...
        <div class="small muted">${defaultShopId
          ? 'Pre-set from this assetZZAPOSZZs type — change it if someone else is doing the work.'
          : 'No default for this type. Set one under Admin ZZARROWZZ Lookups.'}</div></div>
