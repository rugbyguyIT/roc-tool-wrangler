  ...
  formModal(`Send for repair — ${esc(assetLabel || '')}`, `
    ...
    <div class="form-row">
      <div class="form-group"><label class="form-label">Who's fixing it?</label>
        ...
        <div class="small muted">${defaultShopId ? 'Pre-set from this asset’s type — change it if someone else is doing the work.' : 'No default for this type. Set one under Admin → Lookups.'}</div></div>
